...
myname      = 'RBE595';% name for files: myname_T.bin, myname_H.mci  
...
radius      = 0.03;   % 1/e radius of beam at tissue surface
waist       = 0.03;  	% 1/e radius of beam at focus
...
zsurf = 0.01;  % position of air/skin surface
% zsurf = 0;
% 
...
switch mcflag
    case 0 % uniform
        for i=0:N
            plot((-radius + 2*radius*i/N)*[1 1],[zs max(z)],'g-')
        end

    case 1 % Gaussian
        for i=0:N
            plot([(-radius + 2*radius*i/N) xfocus],[zs zfocus],'g-')
        end
